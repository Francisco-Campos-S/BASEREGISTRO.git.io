...
console.log('☁️ FIREBASE INTEGRADO');
...
async function inicializarAplicacion() {
    console.log('🚀 EJECUTANDO inicializarAplicacion() - VERSIÓN CON FIREBASE');
    ...
    const conexionFirebase = await verificarConexionFirebase();
    
    if (conexionFirebase) {
        console.log('☁️ Intentando cargar datos desde Firebase...');
        const datosCargados = await cargarTodoFirebase();
        ...
        console.log('📝 Usando datos locales (sin conexión a Firebase)');
        cargarDatosGuardados();
    }
...
async function guardarDatos() {
    ...
    try {
        ...
        console.log('⚠️ No se pudo guardar en Firebase:', error);
    }
}
